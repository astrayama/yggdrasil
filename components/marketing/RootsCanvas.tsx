...
/**
 * Golden fractal roots drawing themselves downward (~6.5s), then shimmering,
 * with gold spores drifting upward. Ported from the design prototype's
 * initRoots(). Used both as the hero backdrop and (with startWhenVisible) as
 * the closing-CTA growth that only begins once it scrolls into view.
 */
export function RootsCanvas({
  ...
  goldenness?: number;
  /** When true, the roots hold still until the canvas scrolls into view, then grow. */
